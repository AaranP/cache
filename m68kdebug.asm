...
; void Wait_SPI_Write_Complete(){
       xdef      _Wait_SPI_Write_Complete
_Wait_SPI_Write_Complete:
; Enable_SPI_CS();
       move.b    #254,4227112
...
Wait_SPI_Write_Complete_1:
       clr.l     -(A7)
       jsr       _WriteSPIChar
       addq.w    #4,A7
       and.l     #1,D0
       beq.s     Wait_SPI_Write_Complete_3
       bra       Wait_SPI_Write_Complete_1
Wait_SPI_Write_Complete_3:
; Disable_SPI_CS();
       move.b    #255,4227112
       rts
; }
...
_EraseSPI:
; SPI_Write_Enable();
       jsr       _SPI_Write_Enable
; SPI_Command(0xC7);
       pea       199
       jsr       _SPI_Command
       addq.w    #4,A7
; Wait_SPI_Write_Complete();
       jsr       _Wait_SPI_Write_Complete
; SPI_Write_Disable();
       jsr       _SPI_Write_Disable
       rts
; }
; /*******************************************************************
...
; Start = Get8HexDigits(0);
       ...
       cmp.l     #159383551,D7
       bhi       MemoryTest_1
; } while (0x09000000  > Start || 0x097FFFFF < Start);
; // Start = 0x08020000;
; do {
MemoryTest_3:
; printf("\r\nEnd Address") ;
...
; End = Get8HexDigits(0) ;
       ...
       cmp.l     #159383551,D0
       bhi       MemoryTest_3
; } while (Start > End || End > 0x097FFFFF);
; // End = 0x08030000;
...
@m68kde~2_28:
       dc.b      69,114,114,111,114,58,32,68,97,116,97,32,109
       dc.b      105,115,109,97,116,99,104,32,97,116,32,97,100
       dc.b      100,114,101,115,115,32,48,120,37,48,54,88,10
       dc.b      0
@m68kde~2_29:
       dc.b      83,117,99,99,101,115,115,58,32,68,97,116,97
       dc.b      32,118,101,114,105,102,105,101,100,10,0
@m68kde~2_30:
...
@m68kde~2_147:
       ...
       dc.b      0
@m68kde~2_148:
       dc.b      13,10,84,101,115,116,32,112,97,116,116,101,114
       dc.b      110,58,32,13,10,48,58,32,53,53,13,10,49,58,32
       dc.b      65,65,13,10,50,58,32,70,70,13,10,51,58,32,48
       dc.b      48,0
@m68kde~2_149:
       dc.b      13,10,68,97,116,97,32,115,101,108,101,99,116
       dc.b      101,100,58,32,48,120,37,120,0
@m68kde~2_150:
       dc.b      13,10,69,110,116,101,114,32,39,66,39,44,32,39
       dc.b      87,39,44,32,111,114,32,39,76,39,32,102,111,114
       dc.b      32,98,121,116,101,115,44,32,119,111,114,100
       dc.b      115,44,32,111,114,32,108,111,110,103,32,119
       dc.b      111,114,100,58,32,0
@m68kde~2_151:
       dc.b      13,10,98,119,108,32,115,101,108,101,99,116,101
       dc.b      100,58,0
@m68kde~2_152:
       dc.b      76,111,110,103,32,119,111,114,100,0
@m68kde~2_153:
       dc.b      87,111,114,100,0
@m68kde~2_154:
       dc.b      66,121,116,101,115,0
@m68kde~2_155:
       dc.b      13,10,87,114,105,116,101,32,99,111,109,112,108
       dc.b      101,116,101,46,32,83,116,97,114,116,105,110
       dc.b      103,32,114,101,97,100,46,0
@m68kde~2_156:
       dc.b      13,10,87,114,105,116,101,58,32,48,120,37,120
       dc.b      32,116,111,32,97,100,100,114,32,48,120,37,120
       dc.b      0
@m68kde~2_157:
       dc.b      13,10,82,101,97,100,32,99,111,109,112,108,101
       dc.b      116,101,46,0
@m68kde~2_158:
       dc.b      13,10,78,111,32,101,114,114,111,114,32,105,110
       dc.b      32,109,101,109,32,116,101,115,116,0
@m68kde~2_159:
...
@m68kde~2_161:
       ...
       dc.b      115,115,32,48,120,37,120,32,100,97,116,97,32
       dc.b      105,115,32,48,120,37,120,0
@m68kde~2_162:
       dc.b      76,97,98,51,0
@m68kde~2_163:
       dc.b      65,97,114,97,110,32,80,111,111,110,32,51,54
       dc.b      50,50,56,50,48,51,10,80,97,114,115,97,32,75
       dc.b      101,115,104,109,105,114,105,32,51,53,55,50,55
       dc.b      51,55,57,0
@m68kde~2_164:
